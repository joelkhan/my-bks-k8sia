...
var handler = function(request, response) {
  ...
  // 会发现实际输出了8条日志(这是使用探针的响应，如果使用curl，响应日志要多于8条)，
  // 这是因为默认情况下#failure=3（连续3次失败后重启容器，默认period=lOs，所以整体的重启时间间隔是90秒左右）
  ...
  response.end("You've hit " + os.hostname() + ", " + requestCount + " times.\n");
};
